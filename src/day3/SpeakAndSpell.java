...
public class SpeakAndSpell {
	...
	public static void main(String[] args) {
		...
		String answer = JOptionPane.showInputDialog("How does spell?");
		...
		speak("spell Crocodiles");
		answer = JOptionPane.showInputDialog("How does spell?");
		if (answer.equalsIgnoreCase("Crocodiles")) {
			speak("Correct");
		} else {
			speak("Wrong");
		}
